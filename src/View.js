    ...
    <>
      ...
      <div className='cards'>
        <section>
          ...
          <span className='cards__description'>A beautiful and handcrafted monitor stand to reduce neck and eye strain.</span>
          <div className='cards__action'>
            <span id='backproject_btn'>Back this project</span>
            <div>
              <svg id='bookmark_svg' width="56" height="56" xmlns="http://www.w3.org/2000/svg"><g fill="none" fillRule="evenodd"><circle fill="#2F2F2F" cx="28" cy="28" r="28"/><path fill="#B1B1B1" d="M23 19v18l5-5.058L33 37V19z"/></g></svg>
              <span id='bookmark_btn'>Bookmark</span>
            </div>
          </div>
        </section>
        <section>
